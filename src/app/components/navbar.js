...
const Navbar = () => {
 ...
 const router = useRouter()
    ...
    return ( <div className="fixed w-screen z-30  ">
         <div className=" bg-white border-0  flex justify-between px-3 md:px-12 py-4 pb-6 md:py-8 items-center">
          
        <div className="flex space-x-5 items-center">
          <Link href="/">
          <div className="font-bold text-2xl md:text-xl text-slate-950">KaziZetu</div>
     ...
     <div className="flex space-x-4">
      ...
      <div onClick={()=>{
        ...
        }} className="flex relative items-center space-x-3 border cursor-pointer  px-1 border-slate-400 py-[2px] md:py-0 rounded-full">
          <div className="aspect-squire bg-slate-950 rounded-full">
            {userDetails != null ?<Image src={userDetails.image} height={35} width={35} className="rounded-full h-7 w-7 aspect-square object-cover"/>:
